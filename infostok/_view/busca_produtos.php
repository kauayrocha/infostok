...
<main>
    <div id="pesquisa-item" class="input-group alinhar-formulario-2" style="width: 495px; margin-bottom: 10px">
            <input id="campo-pesquisar2" type="text" class="form-control" name="campo-pesquisa" placeholder="Digite aqui o que deseja">
        </div>
        <table id="tables2" class="table alinhar-formulario-2" style="width: 700px" align="center">
            <th>Nº</th>
            <th>Nº Etiqueta</th>
            <th>Descrição</th>
            <th>Categoria</th>
            ...
            foreach ($resultado as $ids) {
                ...
                <tr >
                    ...
                    <td class="table-bordered"><a href="lista_estoque?id=<?= $ids["id"] ?>" class="btn btn-primary"
                                                  style="padding: 2px"><span class="glyphicon glyphicon-ok"></span>Selecionar</a></td>
                </tr>
            <?php
            }
            }
        ...
        <div class="alinhar-formulario" style="width: 90px">
            <ul class="pagination">
                ...
                ?>
                <li><a href="?inicio=<?=$paginaMenos?>&final=<?=$finalMenos?>"><span class="glyphicon glyphicon-chevron-left"></span></a></li>
                <li><a type="button" href="?inicio=<?=$paginaPlus?>&final=<?=$finalPlus?>"><span class="glyphicon glyphicon-chevron-right"></span></a></li>
            </ul>
        </div>
</main>
